            ...
            <div className="login-bg w-screen h-screen max-w-screen max-h-screen content-center justify-items-center">
                <main className="bg-sky-50 min-w-1/2 max-w-screen py-9 px-16 max-h-max rounded-2xl">
                    <div className="flex justify-between max-h-max max-w-full border rounded-md">
                        <button className="w-full py-2 px-12 rounded-l-md">Log In</button>
                        <button className="active-btn w-full py-2 px-12 rounded-r-md">Register</button>
                    </div>
                    ...
                    <button className="border rounded-md content-center my-6 py-4 w-full text-sm">
                        <div className="flex justify-center items-center">
                            ...
                            <a className="ml-2">Register with Google Account</a>
                        </div>
                    </button>
                    ...
                    <form className="grid text-sm">
                        ...
                        <input className="border p-2 rounded-sm" type="text" placeholder="Username"/>

                        <label className="mt-3 my-1">Email</label>
                        <input className="border p-2 rounded-sm" type="text" placeholder="Email Address"/>

                        <label className="mt-3 my-1">Password</label>
                        <input className="border p-2 rounded-sm" type="text" placeholder="Password"/>

                        <button className="gradient-btn py-2 mt-8 rounded-md text-sky-50 font-light">Register</button>
